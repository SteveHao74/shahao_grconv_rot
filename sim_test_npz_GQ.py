...
# depth_img = np.load(dir_root+'7.npz')['d_img']
...
file_path = '/home/abb/Pictures/Data_1_1/'
name_ = '1_Amicelli_800_tex_1_1_1'
img_path = file_path + name_ + '/' + name_ + '.png'
plt.figure(1)
png_f = cv2.imread(img_path)
plt.imshow(png_f)
plt.show()

depth_img = png_f.transpose(2,0,1)[0]/256
depth_img = np.float32(-depth_img/20)
